...
class Settings(BaseSettings):
    ...
    tf_prompt: str = (
        ...
        "layout, lighting, camera angle, camera framing, and wardrobe "
        "colors — the output MUST keep the SAME camera distance, field "
        "of view, and subject size as this image. Do NOT zoom in, crop "
        "tighter, or enlarge the subject relative to this image. Do NOT copy "
